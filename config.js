const CONFIG = {
    introTitle: 'Helo các bạn K47A Khoa Toán',
    introDesc: `Tớ có điều này muốn hỏi cậu, nhớ phải trả lời thật lòng nha :))`,
    btnIntro: 'oui',
    title: 'Cậu yêu Đỗ Đức An có phải không 😙',
    desc: 'Cậu không trả lời hoặc thoát ra, tức là cậu là vợ An đó nha :>',
    btnYes: 'yêu ơi là iuuu <3',
    btnNo: 'An bị ảo à:))',
    question: 'Nói cho tới lý do vì sao cậu yêu An đi <3',
    btnReply: 'Gửi cho Tớ',
    reply: 'Tại vì An hài hước và cực kì đẹp trai hihi <33333',
