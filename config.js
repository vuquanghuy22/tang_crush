const CONFIG = {
    introTitle: 'Helo các cậu',
    introDesc: `Tớ có điều này muốn hỏi cậu, nhớ phải trả lời thật lòng nha :))`,
    btnIntro: 'oui',
    title: 'Các cậu yêu quí tớ có phải không (Vũ Quang Huy) 😙',
    desc: 'Cậu không trả lời hoặc thoát ra là ko đc đâu nha :>',
    btnYes: 'Rất rất quý <3',
    btnNo: 'cậu ảo à:))',
    question: 'Nói cho tới lý do vì sao cậu quý tớ đi <3',
    btnReply: 'Gửi cho Tuyên',
    reply: 'Tại vì cậu đẹp trai và hài hước hihi <33333',
